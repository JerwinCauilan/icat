      ...
      <Header/>
        ...
        <div className='p-5 w-full'>
            <form ref={form} onSubmit={handleSubmit} className='bg-white max-w-5xl p-12 shadow rounded-lg mt-16 mx-auto max-sm:px-5'>
                <h2 className='text-3xl uppercase font-bold mb-5 text-[#520000] max-sm:text-xl'>APPLICATION FORM</h2>    
                ...
                <div className='flex items-center justify-center gap-[30px] mb-8 max-sm:flex-col'>
                    ...
                    <div className="w-1/4 max-sm:w-full">
                        <span className='label-text text-black-700 font-bold select-none'>opt.</span>
                        <input className='w-full p-4 pr-4 text-sm text-[#000] rounded-md border-2 border-solid border-gray-200 outline-none' type="text" placeholder='Suffix(Opt).' name='extensionName' value={extensionName} onChange={handleChange}/>
                    </div>
                </div>
                ...
                <div className="flex items-start justify-center mb-12 max-sm:flex-col">
                    <div className="w-1/2 max-sm:w-full">
                        <h2 className='text-2xl font-bold text-[#520000] break-all text-center max-sm:text-lg'>FOR TRANSFEREES</h2>
                        <p className='mt-6 text-base font-normal text-center max-sm:text-xs'>Name of Secondary School where you currently enrolled/graduated(Do not abbreviate).</p>
                        <span className='label-text text-red-700 font-bold select-none mt-3'>*</span>
                        <input className='w-full p-4 pr-4 text-sm text-[#000] rounded-md border-2 border-solid border-gray-200 outline-none' type="text" placeholder='Input N/A or leave it blank if you are not.' name='school' value={school} onChange={handleChange}/>
                        ...
                        <span className='label-text text-red-700 font-bold select-none mt-3'>*</span>
                        <input className='w-full p-4 pr-4 text-sm text-[#000] rounded-md border-2 border-solid border-gray-200 outline-none' type="text" placeholder='Input N/A or leave it blank if you are not.' name='schoolAddress' value={schoolAddress} onChange={handleChange}/>


                        <p className='mt-6 text-base font-normal text-center max-sm:text-xs'>Previous Course (Write in full)</p>
                        <span className='label-text text-red-700 font-bold select-none mt-3'>*</span>
                        <input className='w-full p-4 pr-4 text-sm text-[#000] rounded-md border-2 border-solid border-gray-200 outline-none' type="text" placeholder='Input N/A or leave it blank if you are not.' name='course' value={course} onChange={handleChange}/>
                    </div>
                </div>
                ...
                <div className='flex items-start justify-center gap-[30px] mb-20 mt-8 max-sm:flex-col'>
                    <div className="w-1/2 max-sm:w-full">
                        ...
                        <p className='label-text text-justify mt-10 max-sm:text-xs'>Form 138/ALS Certificate of Rating for graduates prior to AY 2014-2015; Transfer Certificates for transferring students <br/>(Note: Documents should be readable and completely scanned, Form 138 should be back to back)</p>
